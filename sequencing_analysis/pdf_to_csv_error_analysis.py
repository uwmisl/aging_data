...
# A copy of coverage extraction, but with additional columns for more file error info
...
for filename in all_analyzed_files:
    ...
    if ".txt" in filename:
        ...
        for line in file:
            line_count += 1
            # before, was "Reference"
            if "Average Min Max Total" in line:
                ref_line = line_count
            ...
            if "Insertion Average" in line:
                insertion_avg = line_count + 22
                ins_a = line_count + 24
                ins_c = line_count + 26
                ins_t = line_count + 28
                ins_g = line_count + 30
                deletion_avg = line_count + 32
                del_a = line_count + 34
                del_c = line_count + 36
                del_t = line_count + 38
                del_g = line_count + 40
